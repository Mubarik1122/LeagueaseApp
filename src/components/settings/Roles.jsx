export default function Roles() {
  return (
    <div className="p-6">
      <h2 className="text-lg font-medium text-gray-800 mb-4">Role Management</h2>
      
      <div className="bg-white rounded-lg shadow p-6">
        <div className="space-y-6">
          <div className="border-b pb-4">
            <h3 className="text-md font-medium text-gray-700 mb-2">Available Roles</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="rounded border-gray-300 text-red-600 focus:ring-red-500"
                />
                <label htmlFor="manageMatches" className="text-sm text-gray-600">
                  Can manage matches
                </label>
              </div>
              <div className="flex items-center space-x-2">
