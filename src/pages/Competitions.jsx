...
export default function Competitions() {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-2xl font-semibold text-gray-800 mb-6">Competitions</h1>
      
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-medium text-gray-700">Manage your divisions, cups and teams</h2>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {competitions.map((comp) => (
                <tr key={comp.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Link to={`/teams/${comp.id}`} className="text-blue-600 hover:underline">
                      Add Teams
                    </Link>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-gray-500">{comp.matches}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-gray-500">{comp.results}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-gray-500">{comp.conflicts}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Link to={`/standings/${comp.id}`} className="text-blue-600 hover:underline">
                      Setup
                    </Link>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-gray-500">{comp.shortCode}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
