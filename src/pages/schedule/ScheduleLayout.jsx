...
export default function ScheduleLayout() {
  const { canAdd } = usePagePermission("match-schedule");
  const navItems = SCHEDULE_NAV_ITEMS.filter((item) => {
    if (item.id === "manually-create") return canAdd;
    return true;
  });

  return (
    <RequirePageAccess pageKey="match-schedule">
