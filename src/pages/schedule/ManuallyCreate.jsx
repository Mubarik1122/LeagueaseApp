...
export default function ManuallyCreate() {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <Link to="/schedule" className="text-blue-600 hover:underline flex items-center gap-2">
          ← Back to Manage Matches
        </Link>
      </div>

      <h1 className="text-2xl font-semibold text-gray-800 mb-6">Manually Create Matches</h1>
          ...
          {[
            ...
            <button
              ...
              className={clsx(
                ...
                activeTab === tab.id
                  ? 'bg-white border-t-2 border-red-500 text-gray-900'
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
          <div className="flex">
            ...
            <p className="text-sm text-blue-700">
              To create matches for your selected date either select a checkbox in the grid for the teams you wish to play or select the teams from the lists below then press the create button.
            </p>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex gap-2">
            <select
              ...
              onChange={(e) => setMatchDateTime(prev => ({ ...prev, day: e.target.value }))}
            ...
            <select
              ...
              onChange={(e) => setMatchDateTime(prev => ({ ...prev, year: e.target.value }))}
              className="border border-gray-300 rounded-md px-2 py-1"
            >
              <option>2025</option>
              <option>2026</option>
            ...
            <select
              ...
              onChange={(e) => setMatchDateTime(prev => ({ ...prev, hour: e.target.value }))}
              className="border border-gray-300 rounded-md px-2 py-1"
            >
            ...
            <select
              ...
              onChange={(e) => setMatchDateTime(prev => ({ ...prev, minute: e.target.value }))}
              className="border border-gray-300 rounded-md px-2 py-1"
            >
        ...
        {viewMode === 'grid' ? (
            ...
            <table className="min-w-full border border-gray-200">
              <thead>
                <tr className="bg-gray-50">
                  ...
                  {teams.map(team => (
                    <th key={team.id} className="border-b border-gray-200 px-4 py-2 text-center text-sm font-medium text-gray-500">
                      {team.id}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {teams.map(homeTeam => (
                  <tr key={homeTeam.id}>
                    ...
                    {teams.map(awayTeam => (
                      <td key={awayTeam.id} className="border-b border-gray-200 px-4 py-2 text-center">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-700 mb-2">Home Teams</h3>
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-700 mb-2">Away Teams</h3>
              <div className="space-y-2">
                {teams.map(team => (
                  <label key={team.id} className="flex items-center space-x-2">
                    <input
